...
/*Table structure for table `user_profile_log_tb` */

DROP TABLE IF EXISTS `user_profile_log_tb`;

CREATE TABLE `user_profile_log_tb` (
  `seq` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '번호',
  `ptn_month` tinyint(4) NOT NULL COMMENT '로그 월',
  `ptn_day` INTEGER(20) NOT NULL COMMENT '로그 일',
