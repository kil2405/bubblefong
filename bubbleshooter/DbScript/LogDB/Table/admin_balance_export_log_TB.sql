...
/*Table structure for table `admin_balance_export_log_TB` */

DROP TABLE IF EXISTS `admin_balance_export_log_TB`;

CREATE TABLE `admin_balance_export_log_TB` (
  ...
  `item_type` TINYINT(4) DEFAULT NULL COMMENT '아이템 type',
  `item_id` INTEGER(11) NOT NULL COMMENT 'item id',
  `before_count` INTEGER(11) NOT NULL COMMENT '이전 개수',
  `after_count` INTEGER(11) NOT NULL COMMENT '변경 개수',
  `update_date` INTEGER(11) NOT NULL COMMENT 'update time',
