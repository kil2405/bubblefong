...
/*Table structure for table `admin_gacha_modify_log_tb` */

DROP TABLE IF EXISTS `admin_gacha_modify_log_tb`;

CREATE TABLE `admin_gacha_modify_log_tb` (
  ...
  `gacha_id` INT(11) NOT NULL COMMENT ' 유저 아이디',
  `start_time` BIGINT(20) NOT NULL COMMENT '뽑기 시작 시간',
  `end_time` BIGINT(20) NOT NULL COMMENT '뽑기 끝나는 시간',
  `valid` TINYINT(4) NOT NULL COMMENT '뽑기 진행 여부',
