...
/*Table structure for table `admin_notice_modify_log_TB` */

DROP TABLE IF EXISTS `admin_notice_modify_log_TB`;

CREATE TABLE `admin_notice_modify_log_TB` (
  ...
  `notice_id` int(11) NOT NULL COMMENT ' 공지 아이디',
  ...
  PRIMARY KEY (`seq`,`ptn_month`, `notice_id`)
