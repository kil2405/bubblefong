...
/*Table structure for table `gacha_reward_log_tb` */

DROP TABLE IF EXISTS `gacha_reward_log_tb`;

CREATE TABLE `gacha_reward_log_tb` (
  ...
  `gacha_index` INTEGER(11) NOT NULL COMMENT '뽑기리스트의 seq',
  `gacha_id` INTEGER(11) NOT NULL COMMENT '뽑기 아이디',
  `reward_grade` INTEGER(11) NOT NULL COMMENT '뽑기 당첨 등수',
  `gacha_reward_item` VARCHAR(128) DEFAULT NULL COMMENT '뽑기 당첨 아이템 string',
