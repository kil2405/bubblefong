...
/*Table structure for table `admin_item_modify_log_tb` */

DROP TABLE IF EXISTS `admin_item_modify_log_tb`;

CREATE TABLE `admin_item_modify_log_tb` (
  ...
  `name` VARCHAR(128) DEFAULT NULL COMMENT '아이템 명',
  `item_type` TINYINT(4) NOT NULL COMMENT 'item Type',
  `item_id` INTEGER(11) NOT NULL COMMENT 'item id',
  `before_item_count` INTEGER(11) NOT NULL DEFAULT 0 COMMENT 'item count',
  `after_item_count` INTEGER(11) NOT NULL DEFAULT 0 COMMENT 'item count',
