...
/*Table structure for table `attendance_log_tb` */

DROP TABLE IF EXISTS `attendance_log_tb`;

CREATE TABLE `attendance_log_tb` (
  ...
  `item_type` INTEGER(11) NOT NULL COMMENT 'item Type',
