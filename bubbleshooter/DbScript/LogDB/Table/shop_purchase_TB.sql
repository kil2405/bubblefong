...
/*Table structure for table `shop_purchase_tb` */

DROP TABLE IF EXISTS `shop_purchase_tb`;

CREATE TABLE `shop_purchase_tb` (
  ...
  `product_id` int(11) NOT NULL COMMENT '구매한 상점 아이템',
  `price` int(11) NOT NULL COMMENT '구매 금액',
