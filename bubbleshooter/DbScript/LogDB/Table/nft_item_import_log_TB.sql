...
/*Table structure for table `nft_item_import_log_TB` */

DROP TABLE IF EXISTS `nft_item_import_log_TB`;

CREATE TABLE `nft_item_import_log_TB` (
  ...
  `market_id` varchar(4) NOT NULL COMMENT '마켓에서 생성된 아이템아이디',
  ...
  `grade` int(11) NOT NULL COMMENT '등급',
  `level` int(11) NOT NULL COMMENT '레벨',
  `upgrade` int(11) NOT NULL COMMENT '강화 수치',
  `skill1` int(11) NOT NULL COMMENT '스킬1',
  `skill2` int(11) NOT NULL COMMENT '스킬2',
  `skill3` int(11) NOT NULL COMMENT '스킬3',
