...
/* Procedure structure for procedure `shop_purchase_log_INS_SP` */

/*!50003 DROP PROCEDURE IF EXISTS  `shop_purchase_log_INS_SP` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `shop_purchase_log_INS_SP`(
