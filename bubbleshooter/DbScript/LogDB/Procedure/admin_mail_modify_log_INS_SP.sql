...
/* Procedure structure for procedure `admin_mail_modify_log_INS_SP` */

/*!50003 DROP PROCEDURE IF EXISTS  `admin_mail_modify_log_INS_SP` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `admin_mail_modify_log_INS_SP`( 
...
BEGIN
	INSERT INTO admin_mail_modify_log_TB
	(
		ptn_month
	,	log_time
	,	member_id
