...
/* Procedure structure for procedure `coupon_limit_log_LST_SP` */

/*!50003 DROP PROCEDURE IF EXISTS  `coupon_limit_log_LST_SP` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `coupon_limit_log_LST_SP`(
