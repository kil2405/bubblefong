...
/* Procedure structure for procedure `admin_item_modify_log_INS_SP` */

/*!50003 DROP PROCEDURE IF EXISTS  `admin_item_modify_log_INS_SP` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `admin_item_modify_log_INS_SP`( 
...
BEGIN
	INSERT INTO admin_item_modify_log_TB
	(
		ptn_month
	,	log_time
	,	member_id
