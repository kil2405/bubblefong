...
/* Procedure structure for procedure `mini_game_play_log_INS_SP` */

/*!50003 DROP PROCEDURE IF EXISTS  `mini_game_play_log_INS_SP` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `mini_game_play_log_INS_SP`(
	...
	IN in_rank							INTEGER,
	IN in_ruby							INTEGER,
	IN in_is_ticket						TINYINT
    )
BEGIN
	INSERT INTO mini_game_play_log_tb
	(
		ptn_month
	, 	ptn_day
	, 	log_date
