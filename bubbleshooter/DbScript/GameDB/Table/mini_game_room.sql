...
/*Table structure for table `mini_game_room` */

DROP TABLE IF EXISTS `mini_game_room`;

CREATE TABLE `mini_game_room` (
  `uuid` VARCHAR(48) NOT NULL COMMENT 'room uuid',
  `game_id` INTEGER(11) NOT NULL COMMENT '미니게임id',
  ...
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='미니게임 매칭 방 정보';
