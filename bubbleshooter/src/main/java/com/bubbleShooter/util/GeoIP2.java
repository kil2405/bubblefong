...
public class GeoIP2 {
	...
	private GeoIP2()
	{
//		String RESOURCE_NAME = new ClassPathResource("GeoLite2-City.mmdb").getURI().getPath();
...
//		reader = new DatabaseReader.Builder(file).build();
		...
		if(SystemUtils.OS_NAME.equals("Windows 10") || SystemUtils.OS_NAME.equals("Windows 11"))
			file = new File("D:/WorkSpace/BubblePong_Server/bubbleShooter_webserver/GeoLite2-City.mmdb");
		else
		{
			if(!ServerConfig.SERVER_MODE.equals("live"))
